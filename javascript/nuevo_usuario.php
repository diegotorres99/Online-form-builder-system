            ...
            <div id="Contenedor">
             <br><br><br><br><br>
                    <div class="ContentForm">
                        <form action="" method="post" name="Form_new_user">

                        <div class="input-group input-group-lg">
                                <span class="input-group-addon" id="sizing-addon1"><i class="user"></i></span>
                                <input type="text"  class="form-control" name="" autofocus placeholder="Nombre" id="nombre" aria-describedby="sizing-addon1" required="">
                            </div>
                            <br>
                            <div class="input-group input-group-lg">
                                <span class="input-group-addon" id="sizing-addon1"><i class="user"></i></span>
                                <input type="text" class="form-control" name="" placeholder="Apellidos" id="apellidos" aria-describedby="sizing-addon1" required="">
                            </div>
                            <br>
                            <div class="input-group input-group-lg">
                                <span class="input-group-addon" id="sizing-addon1"><i class="user"></i></span>
                                <input type="text" class="form-control" name="" placeholder="Cédula o Identificación" id="identificacion" aria-describedby="sizing-addon1" required="">
                            </div>
                            <br>
                            <div class="input-group input-group-lg">
                                <span class="input-group-addon" id="sizing-addon1"><i class="user"></i></span>
                                <input type="email" class="form-control" name="" placeholder="Correo" id="correo" aria-describedby="sizing-addon1" required="">
                            </div>
                            <br>
                            <div class="input-group input-group-lg">
                                <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-lock"></i></span>
                                <input type="number" name="telefono" class="form-control" placeholder="Teléfono" aria-describedby="sizing-addon1" required="">
                            </div>
                            <br>
                            <br>
