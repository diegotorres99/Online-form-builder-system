...
h1
{
   font-family: "Oraqle Script";
    ...
    <body style="background-image: linear-gradient(to bottom LEFT, #1B1815, #FF3F85);">
       ...
       <br><br><br><br>
            <center>
                <label for="input">  <h1 style="color: white" > Bienvenido, Formularios Plus</span>  <span span style="color: #EA8C38" >+</span></h1>   </span></label>
           </center>
        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-7">
                  ...
                  <select type="text" v-model="gender" class="form-control">
