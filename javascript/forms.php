...
<body style="background-color:#F0F4F8;"> 
    ...
    <input id= "pregunta_default" name="pregunta_default" type="text" value="<?php echo $pregunta_default; ?>" placeholder ="Nueva Pregunta.."size="37" required>
                        ...
                        <br><hr><center><input name="ActualizarFormulario" type="submit" value="Actualizar"></center>
	...
	#region Título y Descripción del Formulario ya registrado
		...
		echo '<h6>'.$descripcion_formulario.'</center><hr></h6>';
	#endregion
	...
	echo'
	<br><center><input name="GuardarPregunta" type="submit" value="Guardar Pregunta"></center>
	</div> <!-- FIN DE WRAP -->
     ';                   
	...
	<h1>Siguiente Pregunta</h1>
  	<input id= "pregunta_default" name="pregunta_default" type="text" value="<?php echo $pregunta_default; ?>" placeholder ="Nueva Pregunta.."size="37" required>
					  ...
					  <br><hr><center><input name="AddPregunta" type="submit" value="Agregrar Pregunta"></center>
	</div>
	<?php
    } else {
	...
	?>
		...
		$sql = "SELECT a.nombre_formulario as titulo, descripcion_formulario as descripcion, 
							...
							switch ($result->tipo_resp) 
							{
								...
								case "Select List":
											echo '<hr>
										<li><b><label for="cars">'.$result->nombre_preg.'</b></label>
												<select id="opc1" name="opc1" style="max-width:200%;" >
														<option value="opc1">Opcion 1</option>
														<option value="opc1">Opcion 2</option>
														<option value="opc1">Opcion 3</option>
