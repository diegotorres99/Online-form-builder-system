					...
					<div class="row">
							...
							<div class="reviews-item item-style">
								<div class="reviews-item-header">
									<div class="reviews-item-img">
										<img data-src="img/about-us/diego.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
									</div>
									<div class="reviews-item-info">
										<h4 class="reviews-item-title item-title">Luis Diego Torres</h4>
										<div class="reviews-item-position">Junior Developer</div>
									</div>
								</div>
								<div class="reviews-item-text">
                                    <p>
                                    Hello, my name is Diego, I am a Junior Developer, IT Support Technician, Computer Engineering student and Information Technology.
                                    I consider myself passionate about new Technologies and Natures.
                                    </p>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-12 item">
							...
							<div class="reviews-item item-style">
								<div class="reviews-item-header">
									<div class="reviews-item-img">
										<img data-src="img/about-us/william.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
									</div>
									<div class="reviews-item-info">
										<h4 class="reviews-item-title item-title">William Muñoz</h4>
										<div class="reviews-item-position">Junior Developer</div>
									</div>
								</div>
								<div class="reviews-item-text">
									<p>I'm William Romero Muñoz, I live in Cartago, Costa Rica.I like technology and I try to improve every day and learn more about it and everything that I find interesting.</p>
								</div>
							</div><!-- End reviews item -->
						</div>
						<div class="col-lg-4 col-md-12 col-12 item">
							...
							<div class="reviews-item item-style">
								<div class="reviews-item-header">
									<div class="reviews-item-img">
										<img data-src="img/about-us/andrey.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
									</div>
									<div class="reviews-item-info">
										<h4 class="reviews-item-title item-title">Andrey Orozco Viquez</h4>
										<div class="reviews-item-position">Junior Developer</div>
									</div>
								</div>
								<div class="reviews-item-text">
									<p>Hello, My name is Andrey Orozco and I am a software developer with two years of experience. I am currently in the development part of apis for the creation of enrollment systems in educational centers.</p>
								</div>
							</div><!-- End reviews item -->
						</div>
						<div class="col-12">
