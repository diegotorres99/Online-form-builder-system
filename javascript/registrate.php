...
<head>
    ...
    <link rel="stylesheet" href="css/registrate.css" type="text/css">
</head>
<style>
      ...
      <div id="Contenedor">
        ...
        <div class="ContentForm">
             ...
             <div class="input-group input-group-lg">
				  ...
				  <input type="text"  autofocus="autofocus" class="form-control" v-model="nombre"  placeholder="Nombre"  aria-describedby="sizing-addon1" required>
				</div>
            ...
            if (this.nombre !== '' && this.apellidos !== '' 
              ...
              .then(res => {
                ...
                if (res.data.resp_insercion  !=='0') {
                  alert('¡Hecho, Recibiras una Notificacion en tu Correo!')
                  this.nombre = ''
                  this.apellidos = ''
                  this.identificacion = ''
                  this.correo = ''
