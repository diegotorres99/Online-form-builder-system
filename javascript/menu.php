...
<body style="background-color:#F0F4F8;"> 
	...
	<main class="main">
		...
		<div class="main-inner">
								...
								<div class="row flex-nowrap align-items-center justify-content-end">
										...
										<nav class="main-mnu">
											<ul class="main-mnu-list">
												<li class="main-mnu-item-has-child">
													...
													<ul>
														<li><a href="index.html" data-title="Home 1"><span>Home 1</span></a></li>
														<li><a href="home-2.html" data-title="Home 2"><span>Home 2</span></a></li>
														<li><a href="home-3.html" data-title="Home 3"><span>Home 3</span></a></li>
														<li><a href="home-4.html" data-title="Home 4"><span>Home 4</span></a></li>
													</ul>
												</li>
												<li>
												...
												<li class="main-mnu-item-has-child">
													...
													<ul>
														...
														<li><a href="services-2.html" data-title="Services 2"><span>Services 2</span></a></li>
														<li><a href="services-3.html" data-title="Services 3"><span>Services 3</span></a></li>
														<li><a href="services-4.html" data-title="Services 4"><span>Services 4</span></a></li>
														<li><a href="single-services.html" data-title="Single service"><span>Single service</span></a></li>
													</ul>
												</li>
												...
												<li class="main-mnu-item-has-child">
													...
													<ul>
														...
														<li><a href="contact-us-2.html" data-title="Contact Us 2"><span>Contact Us 2</span><div class="mnu-label">new</div></a></li>
													</ul>
												</li>
											</ul>
										</nav><!-- End main menu -->
									...
									<div class="col-auto header-fixed-col d-none d-lg-block">
										...
										<div class="header-lang">
											<div class="header-lang-current hover-link" data-title="En"><span>En</span></div>
								...
								<div class="col">
									<div class="intro-content">
										...
										<div class="intro-desc">
											<p>Formularios Empresariales a la Medida con Trazabilidad, Gestión y Control de Datos en todo Momento !</p>
										</div>
										<div class="intro-btns">
											<a href="../fondo.php" class="btn btn-with-icon btn-small ripple">
					...
					<div class="intro-slider-item" data-flickity-bg-lazyload="img/intro-img2.jpg">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="intro-content">
										<h2 ><span span style="color: #a1cc1b">Estadísticas</span> Utilizando  TI</h2>
										<div class="intro-desc">
											<p>Utilizamos el Avance Tecnológico para utilizar la Información que Recolectas en la Toma de Decisiones Estratégicas.</p>
										</div>
										<div class="intro-btns">
							...
							<div class="row">
								<div class="col">
									<div class="intro-content">
										...
										<div class="intro-desc">
											<p>Gestión, Administración  y Seguimiento de tus Formularios desde cualquier lugar y momento.</p>
										</div>
										<div class="intro-btns">
										<a href="#!" class="btn btn-with-icon btn-small ripple">
												<span> Entrar al Sitio</span>
			...
			<br><br>
			<center><h3 style="color: black">Nuestros Servicios<span span="" style="color: #a1cc1b">+</span></h1></center>
			...
			<section class="section section-projects section-overflow-hidden section-bg">
				<div class="container">
					<div class="row">
						<div class="col-12">
							<div class="wrapp-section-title section-title-center">
								<div class="section-subtitle">Our works</div>
						...
						<div class="col-12">
							<div class="section-nav">
								<ul class="section-nav-list project-nav-list">
									...
									<li data-filter=".project-mobile-apps">MOBILE APPS</li>
									<li data-filter=".project-custom-software">CUSTOM SOFTWARE</li>
									<li data-filter=".project-qa-testing">QA & TESTING</li>
									<li data-filter=".project-ux-design">UX AND DESIGN</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="row" id="projects-container">
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 item project-col project-ux-design">
							...
							<div class="project-item">
								<div class="project-item-card project-item-card-front">
									<img data-src="img/project-img-1.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
								</div>
									...
									<div class="project-item-card-center">
										...
										<div class="wrapp-btn-circl-arrow justify-content-center">
											<a href="single-project.html" class="btn-circl-arrow btn-circl-arrow-white">
												<svg viewBox="0 0 13 9" width="13" height="9" width="13px" height="9px"><use xlink:href="img/sprite.svg#arrow-right"></use></svg>
											</a>
										</div>
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 item project-col">
							...
							<div class="project-item">
								<div class="project-item-card project-item-card-front">
									<img data-src="img/project-img-2.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
								</div>
								<div class="project-item-card project-item-card-back">
									<div class="project-item-card-center">
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 item project-col project-custom-software project-qa-testing">
							...
							<div class="project-item">
								<div class="project-item-card project-item-card-front">
									<img data-src="img/project-img-3.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
								</div>
								<div class="project-item-card project-item-card-back">
									<div class="project-item-card-center">
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 item project-col project-mobile-apps">
							...
							<div class="project-item">
								<div class="project-item-card project-item-card-front">
									<img data-src="img/project-img-4.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
								</div>
								<div class="project-item-card project-item-card-back">
									<div class="project-item-card-center">
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 item project-col project-qa-testing">
							...
							<div class="project-item">
								<div class="project-item-card project-item-card-front">
									<img data-src="img/project-img-5.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
								</div>
								<div class="project-item-card project-item-card-back">
									<div class="project-item-card-center">
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 item project-col project-mobile-apps project-ux-design project-qa-testing">
							...
							<div class="project-item">
								<div class="project-item-card project-item-card-front">
									<img data-src="img/project-img-6.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
								</div>
								<div class="project-item-card project-item-card-back">
									<div class="project-item-card-center">
			...
			<section class="section">
				<div class="container">
					<div class="row">
						<div class="col-12">
							<div class="wrapp-section-title section-title-center">
								<div class="section-subtitle">Reviews from our clients</div>
			...
			<section class="section section-bg">
				<div class="container">
					<div class="row">
						<div class="col-12">
							<div class="wrapp-section-title section-title-center">
								<div class="section-subtitle">More info about</div>
							...
							<div class="footer-item">
								...
								<nav class="footer-nav">
									<ul class="footer-mnu">
										...
										<li><a href="blog.html" class="hover-link" data-title="Blog"><span>Blog</span></a></li>
