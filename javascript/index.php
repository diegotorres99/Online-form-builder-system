								...
								<div class="col">
									<div class="intro-content">
										...
										<div class="intro-desc">
											<p>Formularios Empresariales a la Medida con Trazabilidad, Gestión y Control de Tickets y Datos en todo Momento !</p>
										</div>
										<div class="intro-btns">
											...
											<a href="registrate.php" class="btn btn-with-icon btn-border btn-small ripple">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 item">
							...
							<a href="single-services.html" class="services-item item-style">
								...
								<div class="services-item-desc">Con Globals<span span style="color: #a1cc1b">+</span> tus formularios cobran vida: la edición y las herramientas de trazabilidad permite que sea más fácil la creacion de Formularios y además compartirlos de manera simple.</div>
							</a><!-- End services item -->
						</div>
						<div class="col-lg-4 col-md-6 col-12 item">
							<!-- Begin services item -->
							<a href="single-services.html" class="services-item item-style">
								...
								<div class="services-item-desc">Ayuda a equipos a entregar fantásticas experiencias de servicio, conoce como trabajan tus colaboradores y Acelera el trabajo de desarrollo crítico e implementa cambios fácilmente.</div>
							</a><!-- End services item -->
						</div>
						<div class="col-lg-4 col-md-12 col-12 item">
							...
							<a href="single-services.html" class="services-item item-style">
								...
								<div class="services-item-desc">Registros interactivos que permiten monitorear el progreso de resolución de las solicitudes de los clientes, permiten que varios agentes colaboren en tareas complejas y proporcionan una visión contextual de la experiencia de cada cliente, y un sistema de gestión.</div>
							</a><!-- End services item -->
						</div>
						<div class="col-12">
